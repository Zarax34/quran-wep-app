from flask import Blueprint, render_template, request, redirect, url_for, flash, session, jsonify, send_from_directory, make_response, current_app
...
from app.models import (
    User, Parent, Circle, Student, MonthlyPlan, Report, Attendance, Holiday, Settings,
    Notification, Point, Badge, StudentBadge, HonorBoard, UserLogin, EducationalNote,
    Announcement, Conversation, Message, CenterActivity, ActivityApproval, Alumni, Fee,
    Work, ParentNote, Course, CourseEnrollment, Test, TestScore, Certificate,
    activity_circles, holiday_circles
)
...
@main_bp.route('/set_view/<view_type>')
@require_login
...
@main_bp.route('/upload_students_excel', methods=['GET', 'POST'])
@require_role('admin')
...
@main_bp.route('/move_student/<int:student_id>', methods=['POST'])
@require_login
...
@main_bp.route('/delete_student/<int:student_id>')
@require_login
...
@main_bp.route('/reject_student/<int:student_id>')
@require_role('admin')
...
@main_bp.route('/add_circle', methods=['GET', 'POST'])
@require_role('admin')
def add_circle():
    if request.method == 'POST':
        name = request.form['name']
...
@main_bp.route('/edit_circle/<int:circle_id>', methods=['GET', 'POST'])
@require_role('admin')
...
@main_bp.route('/approve_circle/<int:circle_id>')
@require_role('admin')
...
@main_bp.route('/update_honor_board_manual')
@require_role('admin')
...
@main_bp.route('/reject_circle/<int:circle_id>')
@require_role('admin')
...
@main_bp.route('/add_report', methods=['GET', 'POST'])
@require_login
def add_report():
    if request.method == 'POST':
...
@main_bp.route('/collective_report', methods=['GET', 'POST'])
@require_login
...
@main_bp.route('/collective_report/<int:circle_id>', methods=['GET'])
@require_login
...
@main_bp.route('/collective_report_submit/<int:circle_id>', methods=['POST'])
@require_login
...
@main_bp.route('/update_attendance', methods=['POST'])
@require_login
...
@main_bp.route('/add_holiday', methods=['GET', 'POST'])
@require_login
def add_holiday():
    if request.method == 'POST':
...
@main_bp.route('/approve_holiday/<int:holiday_id>')
@require_role('admin')
...
@main_bp.route('/add_parents', methods=['GET', 'POST'])
@require_role('admin')
def add_parents():
    if request.method == 'POST':
...
@main_bp.route('/link_students_to_parents', methods=['GET', 'POST'])
@require_role('admin')
...
@main_bp.route('/add_announcement', methods=['GET', 'POST'])
@require_role('admin')
...
@main_bp.route('/generate_monthly_fees', methods=['GET', 'POST'])
@require_role('admin')
...
@main_bp.route('/confirm_fee_payment/<int:fee_id>', methods=['POST'])
@require_login
...
@main_bp.route('/add_fee', methods=['GET', 'POST'])
@require_login
def add_fee():
    if request.method == 'POST':
        student_id = request.form.get('student_id')
...
@main_bp.route('/edit_fee/<int:fee_id>', methods=['GET', 'POST'])
@require_login
def edit_fee(fee_id):
    fee = Fee.query.get_or_404(fee_id)
    if request.method == 'POST':
...
@main_bp.route('/delete_fee/<int:fee_id>', methods=['POST'])
@require_login
...
@main_bp.route('/edit_alumni/<int:alumni_id>', methods=['GET', 'POST'])
@require_role('admin')
...
@main_bp.route('/delete_alumni/<int:alumni_id>', methods=['POST'])
@require_role('admin')
...
@main_bp.route('/edit_work/<int:work_id>', methods=['GET', 'POST'])
@require_role('admin')
...
@main_bp.route('/delete_work/<int:work_id>', methods=['POST'])
@require_role('admin')
...
@main_bp.route('/api/get_surah_details', methods=['GET'])
...
@main_bp.route('/api/fingerprint_login', methods=['POST'])
...
@main_bp.route('/api/student_details/<int:student_id>')
@require_login
...
@main_bp.route('/block_user/<int:user_id>')
@require_role('admin')
...
def settings():
    ...
    if request.method == 'POST':
        ...
        if login_background and allowed_file(login_background.filename):
            ...
            login_background.save(os.path.join(current_app.config['UPLOAD_FOLDER'], bg_filename))
...
def delete_logo():
    ...
    if settings_obj and settings_obj.logo:
        try:
            # حذف ملف الشعار
            logo_path = os.path.join(current_app.config['UPLOAD_FOLDER'], settings_obj.logo)
...
# ---------- 18.  WHATSAPP ----------
@main_bp.route('/send_whatsapp_report/<int:student_id>/<report_type>')
@require_login
...
@main_bp.route('/admin/parent_notes')
@require_role('admin')
...
@main_bp.route('/admin/mark_note_read/<int:note_id>')
@require_role('admin')
...
# ---------- 21.  STUDENT REPORTS ----------
@main_bp.route('/add_educational_note/<int:student_id>', methods=['POST'])
@require_login
...
@main_bp.route('/student_reports/<int:student_id>')
@require_login
...
@main_bp.route('/export_student_report/<int:student_id>')
@require_login
...
@main_bp.route('/edit_course/<int:course_id>', methods=['GET', 'POST'])
@require_login
...
@main_bp.route('/delete_course/<int:course_id>')
@require_login
...
@main_bp.route('/enroll_student/<int:course_id>', methods=['POST'])
@require_login
...
@main_bp.route('/add_test/<int:course_id>', methods=['POST'])
@require_login
...
@main_bp.route('/parent/settings', methods=['GET', 'POST'])
@require_login
@require_role('parent')
def parent_settings():
...
@main_bp.route('/teacher/settings', methods=['GET', 'POST'])
@require_login
...
@main_bp.route('/certificates', methods=['GET', 'POST'])
@require_role('admin')
def certificates():
    if request.method == 'POST':
